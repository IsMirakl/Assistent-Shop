...
START_TEXT = "Привет, я  онлайн Ассистент.У меня ты можешь выбрать и забронировать товар онлайн"
CONNECTION_TEXT = "Задать вопрос по товару/работе магазина - @ShopManager\nТех.поддержка бота - @Support\nНаша почта: shop@gmail.ru"
...
async def connection(callback: CallbackQuery):
    ...
    await callback.message.edit_text(text=CONNECTION_TEXT, reply_markup=kb.to_main)
