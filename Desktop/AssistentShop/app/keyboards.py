...
connection = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text='Связь', callback_data='connection')]   
])

admin_main = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text='Рассылка', callback_data='send_letter')]
])
